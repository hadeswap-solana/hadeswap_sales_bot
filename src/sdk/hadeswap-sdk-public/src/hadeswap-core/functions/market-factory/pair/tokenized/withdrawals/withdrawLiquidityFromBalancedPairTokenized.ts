...
type WithdrawLiquidityFromBalancedPairTokenized = (params: {
...
export const withdrawLiquidityFromBalancedPairTokenized: WithdrawLiquidityFromBalancedPairTokenized = async ({
  programId,
  connection,
  accounts,
  sendTxn,
  ...
  instructions.push(
    await program.methods
      .withdrawLiquidityFromBalancedPairTokenized()
      .accounts({
